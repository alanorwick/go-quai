...
type tdBlock struct {
	...
	AnnouncePending bool                `json:"announcePending"`
...
func (s *PublicBlockChainQuaiAPI) Append(ctx context.Context, raw json.RawMessage) (map[string]interface{}, error) {
	...
	pendingEtxs, err := s.b.Append(body.Header, body.DomPendingHeader, body.DomTerminus, body.Td, body.DomOrigin, body.AnnouncePending, body.Reorg, body.NewInboundEtxs)
	if err != nil {
		return nil, err
	}
