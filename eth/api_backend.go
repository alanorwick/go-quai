...
func (b *QuaiAPIBackend) Append(header *types.Header, domPendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, announcePending bool, reorg bool, newInboundEtxs types.Transactions) ([]types.Transactions, error) {
	return b.eth.core.Append(header, domPendingHeader, domTerminus, td, domOrigin, announcePending, reorg, newInboundEtxs)
}
